...
- feat(logaria): support preset-backed rule configs ([bd90aa6](https://github.com/XiSenao/docs-islands/commit/bd90aa6))
...
- test(logaria): restructure test suite with focused specs and documentation ([44815e4](https://github.com/XiSenao/docs-islands/commit/44815e4))
...
- refactor(logaria): unify managed logger facade ([d5dfe51](https://github.com/XiSenao/docs-islands/commit/d5dfe51))
...
- chore(logaria): refresh bundled license manifest ([2d717c5](https://github.com/XiSenao/docs-islands/commit/2d717c5))
...
- feat(logaria): add cross-bundler loggerPlugin ([ffa63aa](https://github.com/XiSenao/docs-islands/commit/ffa63aa))
...
- chore(logaria): pre-release preparation ([580ded8](https://github.com/XiSenao/docs-islands/commit/580ded8))
