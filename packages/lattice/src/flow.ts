...
export interface LatticeFlowReporterOptions {
  clack?: ClackAdapter;
...
export interface LatticeFlowMessageOptions {
  collapseOnSuccess?: boolean;
  depth?: number;
  elapsedTimeMs?: number;
}

export interface LatticeFlowFailureOptions extends LatticeFlowMessageOptions {
  error?: unknown;
}

export interface LatticeFlowTask {
  fail: (message?: string, options?: LatticeFlowFailureOptions) => void;
  info: (message: string, options?: LatticeFlowMessageOptions) => void;
  pass: (message?: string, options?: LatticeFlowMessageOptions) => void;
  skip: (message?: string, options?: LatticeFlowMessageOptions) => void;
  warn: (message: string, options?: LatticeFlowMessageOptions) => void;
}

export interface LatticeFlowOutputOptions {
...
export class LatticeFlowReporter {
  ...
  constructor(options: LatticeFlowReporterOptions = {}) {
  ...
  start(
    message: string,
    options: LatticeFlowMessageOptions = {},
  ): LatticeFlowTask {
  ...
  writeOutput(
    ...
    options: LatticeFlowOutputOptions = {},
  ): void {
...
export function createLatticeFlowReporter(
  options: LatticeFlowReporterOptions = {},
): LatticeFlowReporter {
  return new LatticeFlowReporter(options);
}
