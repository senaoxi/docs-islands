...
| `Missing peer dependency ...`                                                                         | A checker, package check, or release integration tool is not installed                                      | Install the reported peer dependency, such as `typescript`, `vue-tsc`, `knip`, `publint`, `@arethetypeswrong/core`, or `npm-package-json-lint` |
