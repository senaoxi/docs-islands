...
`reason` explains why this file is safe to leave outside normal checker coverage. It must not be empty because allowlist entries are reviewable architecture exceptions, not only a switch to turn CI green.
