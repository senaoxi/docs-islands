...
| I05       | NativeDependencyFact discriminated fields / symbol evidence tests       | Ambient+membership, included/external controls, augmentation                   | Program/Symbol identity, admitted scripts, actual declaration providers, ambient membership                |
| I06       | Edge union / reference-recording requirement / declaration guards       | Concrete managed output, framework-only scheduling, implicit refs              | Physical declaration companions stop bootstrap; missing source preserves real schedule edges               |
